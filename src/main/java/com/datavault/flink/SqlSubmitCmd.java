...
package com.datavault.flink;

import com.datavault.flink.cli.CliOptions;
import com.datavault.flink.cli.CliOptionsParser;
import com.datavault.flink.cli.SqlCommandParser;
import com.datavault.flink.cli.SqlCommandParser.SqlCommandCall;
...
public class SqlSubmitCmd {

    public static void main(String[] args) throws Exception {
        final CliOptions options = CliOptionsParser.parseClient(args);
        SqlSubmitCmd submit = new SqlSubmitCmd(options);
        submit.run();
    }
    ...
    private SqlSubmitCmd(CliOptions options) {
